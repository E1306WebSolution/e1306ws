    ...
    <main>
     ...
     <section className="h-[88vh] bg-[url('/images/banner.jpg')] mt-[10vh] bg-cover bg-center relative">
      ...
      <Particle />
        ...
        <div className="w-full lg:w-1/2 p-6">
          <h1 className="text-[35px] md:text-[50px] font-bold">
            Hi, We’re Here at <span className="text-yellow-400">E1306!</span>
          </h1>

          <TextEffect />

          <p className="mt-6 text-[18px] text-[#ffffff92] max-w-md">
            A Digital Marketing Agency in Greater Noida catering to NCR (Delhi) and providing global solutions for your online presence in 2024 with the best web frameworks like Next.js and React.js, at the cost of a WordPress website.
          </p>

          <div className="mt-8 flex flex-col sm:flex-row space-y-6 sm:space-y-0 sm:space-x-6">
            <button className="px-8 py-4 text-[18px] font-bold uppercase bg-[#55e6a5] hover:bg-yellow-400 transition-all duration-200 text-black flex items-center space-x-2">
              <p>Contact Us</p>
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center lg:justify-end">
          <div className="relative w-[500px] h-[500px] hidden lg:block bg-[#55e6a5] rounded-full overflow-hidden">
      ...
      {/* <section className="container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center"> */}
        {/* copy of this file  */}
         {/* Did not need the below section */}
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
          <img src="//public/images/p/blog1.jpg" alt="typescript" className="w-full h-64 object-cover rounded-t-lg"/>
          <div className="mt-4">
